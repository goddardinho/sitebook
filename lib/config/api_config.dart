...
class ApiConfig {
  ...
  static String get googleMapsApiKey {
    ...
    throw Exception('Google Maps API key not provided! Use --dart-define GOOGLE_MAPS_API_KEY=your_key');
  }

  // Recreation.gov API configuration
  static String get recreationGovApiKey {
    const String envKey = String.fromEnvironment('RECREATION_GOV_API_KEY',
      defaultValue: 'YOUR_API_KEY_HERE');
    return envKey;
  }
  
  // Base URLs
  static const String recreationGovBaseUrl = 'https://ridb.recreation.gov/api/v1';
