...
class DemoDataProvider {
  static final List<Campground> _sampleCampgrounds = [
    Campground(
      ...
      description: 'Stunning wilderness camping surrounded by towering granite cliffs and pristine forests. Wake up to incredible views of Half Dome and El Capitan.',
      latitude: 37.7459,
      longitude: -119.5873,
      state: 'CA',
      parkName: 'Yosemite National Park',
      amenities: const [
        'Restrooms', 'Fire Pits', 'Water', 'Picnic Tables', 
        'Bear Lockers', 'Showers', 'Phone Service'
      ],
      activities: const [
        'Hiking', 'Rock Climbing', 'Photography', 'Wildlife Viewing',
        'Fishing', 'Stargazing'
      ],
      imageUrls: const [],
    ...
    Campground(
      ...
      description: 'Breathtaking oceanfront camping with dramatic coastal views and rugged hiking trails along the Pacific Coast Highway.',
      latitude: 36.2704,
      longitude: -121.8081,
      state: 'CA',
      amenities: const [
        'Restrooms', 'Showers', 'Fire Rings', 'Water',
        'Picnic Tables', 'Beach Access'
      ],
      activities: const [
        'Hiking', 'Beach Walking', 'Surfing', 'Bird Watching',
    ...
    Campground(
      ...
      description: 'High elevation mountain camping with crystal clear lake views, excellent fishing, and alpine hiking trails.',
      latitude: 39.0968,
      longitude: -120.0324,
      state: 'CA',
      amenities: const [
        'Restrooms', 'Fire Pits', 'Boat Launch', 'Picnic Tables',
        'Water', 'Fishing Pier'
      ],
      activities: const [
    ...
    Campground(
      ...
      description: 'Unique desert camping experience among iconic Joshua Trees and fascinating rock formations perfect for climbing.',
      latitude: 33.8734,
      longitude: -115.9010,
      state: 'CA',
      ...
      activities: const [
        'Hiking', 'Rock Climbing', 'Stargazing', 'Photography',
        'Desert Exploration', 'Nature Study'
      ],
      imageUrls: const [],
    ...
    Campground(
      ...
      description: 'Camp among ancient giant sequoia trees in this pristine mountain forest setting with incredible hiking.',
      latitude: 36.5647,
      longitude: -118.7732,
      state: 'CA',
      parkName: 'Sequoia National Park',
      amenities: const [
        'Restrooms', 'Water', 'Fire Pits', 'Bear Lockers',
        'Picnic Tables', 'Interpretive Programs'
      ],
      activities: const [
        'Hiking', 'Wildlife Viewing', 'Photography',
        'Ranger Programs', 'Nature Walks'
      ],
      imageUrls: const [],
      isMonitored: false,
    ),
    ...
    Campground(
      ...
      description: 'Gateway to spectacular red rock canyons and world-class hiking trails in Zion National Park.',
      latitude: 37.2002,
      longitude: -113.0164,
      state: 'UT',
      ...
      amenities: const [
        'Restrooms', 'Showers', 'Fire Rings', 'Water',
        'Picnic Tables', 'Shuttle Access'
      ],
      activities: const [
        'Hiking', 'Canyoneering', 'Photography', 'Rock Climbing',
        'Wildlife Viewing', 'River Tubing'
      ],
      imageUrls: const [],
  ...
  static List<Campground> searchByQuery(String query) =>
      _sampleCampgrounds.where((c) =>
...
final demoSearchProvider = Provider.family<List<Campground>, String>((ref, query) {
  if (query.isEmpty) return DemoDataProvider.getAllCampgrounds();
  return DemoDataProvider.searchByQuery(query);
});

final demoStateProvider = Provider.family<List<Campground>, String>((ref, state) {
